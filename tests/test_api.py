...
class TestAPI(BaseTestConfig):
    ...
    def test_create_new_user(self):
        self.assertIsNone(User.objects.filter(
        ...
        self.assertEqual(User.objects.filter(email=self.some_user["email"]).first().email, self.some_user["email"])
